...
class MeshConvNet(nn.Module):
    ...
    def __init__(self, norm_layer, nf0, conv_res, nclasses, input_res, pool_res, fc_n,
        ...
        norm_args = get_norm_args(norm_layer, self.k[1:]) # not sure what and how this is working . it seems to take conv res as an input
...
class MResConv(nn.Module):
    def __init__(self, in_channels, out_channels, skips=1):
        '''
        Param:
        in_channels : the input channal features
        out_channels: the output channal count
        skips : residual connection
        Return:
