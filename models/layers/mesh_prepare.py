...
def fill_mesh(mesh2fill, file: str, opt):
    ...
    if os.path.exists(load_path):
        mesh_data = np.load(load_path, encoding='latin1', allow_pickle=True) # i guess this is where the file is loaded
    else:
...
def fill_from_file(mesh, file):# this is where the obj file is read for sure . here we can see 'v' and 'f'
